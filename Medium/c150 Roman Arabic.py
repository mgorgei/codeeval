...
This challenge involves calculating the value of “aromatic” numbers which are a
...
numeral has a base value: 1, 5, 10, 50, 100, 500, 1000, respectively. 
...
calculates the values of aromatic numbers. 
